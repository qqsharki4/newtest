...
# (at your option) any later version. egbebertbаперр
# 1et
# This program is distributed in the hope that it will be useful,
# but WITHOUT ANY WARRANTY; without even the implied warranty of
# MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
# GNU Affero General Public License for more details.ыещшгигкыеригшркдшгрршгирдшгрдрдраиашепридшгапч м
# kujyg
# You should have received a copy of the GNU Affero General Public License
# along with this program. If not, see <https://www.gnu.org/licenses/>.2
...
@loader.tds
class UltraPronMod(loader.Module):
    """Простой модуль показывающий сколько дней до дня рождения (by @qq_shark)"""

    strings = {
        "name": "Birthday",
        "birthday_today": "🎉 Сегодня твой день рождения! Поздравляю!вввв 🎂",
