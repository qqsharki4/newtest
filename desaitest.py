...
class ChatModuleMod(loader.Module):
    ...
    strings_ru = {
        ...
        "all_roles": "<blockquote expandable><emoji document_id=6023985764885338464>📜</emoji><b> Все роли:</b>\n\n{roles}</blockquote>",
        "role_info": "<blockquote expandable><emoji document_id=6023985764885338464>📜</emoji><b> Права роли <code>{name}</code>:</b>\n\n{rights}</blockquote>",
